  ...
  Widget build(BuildContext context) {
    Future.wait([
      for (int i = 1; i < 3; i++)
        precachePicture(
          ExactAssetPicture(
              SvgPicture.svgStringDecoderBuilder, 'assets/images/intro$i.svg'),
          null,
        ),
              ...
              children: [
                ...
                Align(
                  ...
                  child: RoundedGradientButton(
                    text: _infoStep == 2 ? 'get_started'.tr : 'next'.tr,
                    width: _infoStep == 2 ? 155.0 : 110.0,
